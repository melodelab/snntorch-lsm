...
for i in range(reps):
    ...
    for in_conn_gabor in in_conns_gabor:
        score = long_short_Gabor_ensemble_lsm(
            in_conn_gabor, long_dist1=long_dist1, long_dist2=long_dist2
        )
...
save_path = "./"
np.savez(
    save_path + "ensemble_comparisons_3_reservoir_2",
    params_gabor=params_gabor_np,
    scores_gabor=scores_gabor_np,
    params_simple=params_simple_np,
    scores_simple=scores_simple_np,
)
